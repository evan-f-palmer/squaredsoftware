package com.squaredsoftware.input.gdx;
...
import com.squaredsoftware.input.conditionalInput.Conditional;
...
public class GdxInputTest implements ApplicationListener {
	...
	@Override
	public void create() {		
		Gdx.app.log("About", "uses the keys ctrl, alt, a and tap to run a basic test of the vInput.");
